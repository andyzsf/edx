    ...
    with modulestore().bulk_operations(course_key):
        ...
        if 'text/html' in request.META.get('HTTP_ACCEPT', '') and request.method == 'GET':
            ...
            if request.method == 'GET':
                ...
                # Retrieve pre-requisite course key from milestones if already set
                #if prerequisite_course_enabled and milestones_app_enabled:
                    #prerequisite_course_key = get_prerequisite_course_key(course_key)
                    #setattr(course_details, 'pre_requisite_course', prerequisite_course_key)
